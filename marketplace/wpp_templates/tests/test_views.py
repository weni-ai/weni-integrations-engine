...
class WhatsappTranslationCreateTestCase(APIBaseTestCase):
    ...
    def setUp(self):
        ...
        self.body = dict(
            ...
            header={"header_type": "DOCUMENT", "example": f},
