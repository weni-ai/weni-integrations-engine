...
class TemplateButtonModelTestCase(TestCase):
    ...
    def test_create_template_button_url_required_fail(self):
        with self.assertRaises(ValidationError):
            TemplateButton.objects.create(template_translation=self.template_translation, button_type="URL")

    def test_create_template_button_phone_number_required_fail(self):
        with self.assertRaises(ValidationError):
            TemplateButton.objects.create(template_translation=self.template_translation, button_type="PHONE_NUMBER")
...
class TemplateHeaderModelTestCase(TestCase):
    ...
    def test_create_template_header_text_required_fail(self):
        with self.assertRaises(ValidationError):
            TemplateHeader.objects.create(template_translation=self.template_translation, header_type="URL")
