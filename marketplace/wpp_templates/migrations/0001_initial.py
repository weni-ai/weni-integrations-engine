                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            (
                                "ACCOUNT_UPDATE",
                                "WhatsApp.data.templates.category.account_update",
                            ),
                            (
                                "PAYMENT_UPDATE",
                                "WhatsApp.data.templates.category.payment_update",
                            ),
                            (
                            ...
                            (
                                "SHIPPING_UPDATE",
                                "WhatsApp.data.templates.category.shipping_update",
                            ),
                            (
                                "RESERVATION_UPDATE",
                                "WhatsApp.data.templates.category.reservation_update",
                            ),
                            (
                                "ISSUE_RESOLUTION",
                                "WhatsApp.data.templates.category.issue_resolution",
                            ),
                            (
                                "APPOINTMENT_UPDATE",
                                "WhatsApp.data.templates.category.appointment_update",
                            ),
                            (
                            ...
                            (
                                "TICKET_UPDATE",
                                "WhatsApp.data.templates.category.ticket_update",
                            ),
                            (
                                "ALERT_UPDATE",
                                "WhatsApp.data.templates.category.alert_update",
                            ),
                            (
                                "AUTO_REPLY",
                                "WhatsApp.data.templates.category.auto_reply",
                            ),
                            (
                                "TRANSACTIONAL",
                                "WhatsApp.data.templates.category.transactional",
                            ),
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            (
                                "APPROVED",
                                "WhatsApp.data.templates.translaction.status.approved",
                            ),
                            (
                                "IN_APPEAL",
                                "WhatsApp.data.templates.translaction.status.in_appeal",
                            ),
                            (
                                "PENDING",
                                "WhatsApp.data.templates.translaction.status.pending",
                            ),
                            (
                                "REJECTED",
                                "WhatsApp.data.templates.translaction.status.rejected",
                            ),
                            (
                                "PENDING_DELETION",
                            ...
                            (
                                "DELETED",
                                "WhatsApp.data.templates.translaction.status.deleted",
                            ),
                            (
                                "DISABLED",
                                "WhatsApp.data.templates.translaction.status.disabled",
                            ),
                            (
                                "LOCKED",
                                "WhatsApp.data.templates.translaction.status.locked",
                            ),
                        ],
                        max_length=20,
                        null=True,
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            (
                                "DOCUMENT",
                                "WhatsApp.data.templates.header.types.document",
                            ),
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            (
                                "QUICK_REPLY",
                                "WhatsApp.data.templates.buttons.type.quick_reply",
                            ),
                            (
                                "PHONE_NUMBER",
