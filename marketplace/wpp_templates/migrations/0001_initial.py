    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('app', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='template', to='applications.app')),
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='created_templatemessages', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('uuid', models.UUIDField(default=uuid.uuid4, editable=False, unique=True)),
                ('status', models.CharField(choices=[('APPROVED', 'WhatsApp.data.templates.translaction.status.approved'), ('IN_APPEAL', 'WhatsApp.data.templates.translaction.status.in_appeal'), ('PENDING', 'WhatsApp.data.templates.translaction.status.pending'), ('REJECTED', 'WhatsApp.data.templates.translaction.status.rejected'), ('PENDING_DELETION', 'WhatsApp.data.templates.translaction.status.pending_deletion'), ('DELETED', 'WhatsApp.data.templates.translaction.status.deleted'), ('DISABLED', 'WhatsApp.data.templates.translaction.status.disabled'), ('LOCKED', 'WhatsApp.data.templates.translaction.status.locked')], max_length=20, null=True)),
                ...
                ('template', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='translations', to='wpp_templates.templatemessage')),
            ],
        ),
        migrations.CreateModel(
            name='TemplateHeader',
            fields=[
                ...
                ('translation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='headers', to='wpp_templates.templatetranslation')),
            ],
        ),
        migrations.CreateModel(
            name='TemplateButton',
            fields=[
                ...
                ('translation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='buttons', to='wpp_templates.templatetranslation')),
            ],
        ),
    ]
