...
# class ConfigureChatGPTAppTestCase(APIBaseTestCase):
#     view_class = ChatGPTViewSet
...
#         )
#         self.user_authorization.set_role(ProjectAuthorization.ROLE_ADMIN)
#         self.url = reverse("chatgpt-app-configure", kwargs={"uuid": self.app.uuid})
...
#     @patch(
#         "marketplace.core.types.externals.chatgpt.serializers.FlowsClient.create_external_service"
#     )
#     def test_configure_chatgpt_success(self, mock_create_external_service):
#         data = {
